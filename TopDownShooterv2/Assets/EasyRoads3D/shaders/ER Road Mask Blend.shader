...
Shader "EasyRoads3D/ER Road Mask Blend"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			TEXTURE2D(_DetailNormalMapScale);
			SAMPLER(sampler_DetailNormalMapScale);
			TEXTURE2D(_Metallic);
			SAMPLER(sampler_Metallic);
			TEXTURE2D(_MetallicGlossMap2);
			SAMPLER(sampler_MetallicGlossMap2);
						...
						)
			{
				...
				float2 texCoord32 = packedInput.ase_texcoord5.zw * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode30 = SAMPLE_TEXTURE2D( _Mask, sampler_Mask, texCoord32 );
				float4 lerpResult16 = lerp( ( tex2DNode1 * _Color ) , ( SAMPLE_TEXTURE2D( _Albedo, sampler_Albedo, uv_Albedo ) * _Color0 ) , tex2DNode30.g);
				
				float2 texCoord40 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float3 unpack5 = UnpackNormalScale( SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, texCoord40 ), _BumpScale );
				unpack5.z = lerp( 1, unpack5.z, saturate(_BumpScale) );
				float2 texCoord44 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float3 unpack23 = UnpackNormalScale( SAMPLE_TEXTURE2D( _DetailNormalMapScale, sampler_DetailNormalMapScale, texCoord44 ), _BumpScale1 );
				...
				float4 tex2DNode2 = SAMPLE_TEXTURE2D( _Metallic, sampler_Metallic, uv_Metallic );
				float2 uv_MetallicGlossMap2 = packedInput.ase_texcoord5.xy * _MetallicGlossMap2_ST.xy + _MetallicGlossMap2_ST.zw;
				float4 tex2DNode25 = SAMPLE_TEXTURE2D( _MetallicGlossMap2, sampler_MetallicGlossMap2, uv_MetallicGlossMap2 );
				...
				surfaceDescription.Albedo = lerpResult16.rgb;
				surfaceDescription.Normal = BlendNormal( unpack5 , unpack23 );
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = lerpResult26;
				...
				surfaceDescription.Smoothness = lerpResult27;
				surfaceDescription.Occlusion = lerpResult29;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 texCoord32 = packedInput.ase_texcoord.zw * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode30 = SAMPLE_TEXTURE2D( _Mask, sampler_Mask, texCoord32 );
				float4 lerpResult16 = lerp( ( tex2DNode1 * _Color ) , ( SAMPLE_TEXTURE2D( _Albedo, sampler_Albedo, uv_Albedo ) * _Color0 ) , tex2DNode30.g);
				
				float2 texCoord40 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float3 unpack5 = UnpackNormalScale( SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, texCoord40 ), _BumpScale );
				unpack5.z = lerp( 1, unpack5.z, saturate(_BumpScale) );
				float2 texCoord44 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float3 unpack23 = UnpackNormalScale( SAMPLE_TEXTURE2D( _DetailNormalMapScale, sampler_DetailNormalMapScale, texCoord44 ), _BumpScale1 );
				unpack23.z = lerp( 1, unpack23.z, saturate(_BumpScale1) );
				
				float2 uv_Metallic = packedInput.ase_texcoord.xy * _Metallic_ST.xy + _Metallic_ST.zw;
				float4 tex2DNode2 = SAMPLE_TEXTURE2D( _Metallic, sampler_Metallic, uv_Metallic );
				float2 uv_MetallicGlossMap2 = packedInput.ase_texcoord.xy * _MetallicGlossMap2_ST.xy + _MetallicGlossMap2_ST.zw;
				float4 tex2DNode25 = SAMPLE_TEXTURE2D( _MetallicGlossMap2, sampler_MetallicGlossMap2, uv_MetallicGlossMap2 );
				float lerpResult26 = lerp( ( tex2DNode2.r * _MetallicPower ) , ( tex2DNode25.r * _Float0 ) , tex2DNode30.g);
		...
		Pass
		{
					...
					)
			{
				...
				float2 texCoord40 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float3 unpack5 = UnpackNormalScale( SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, texCoord40 ), _BumpScale );
				unpack5.z = lerp( 1, unpack5.z, saturate(_BumpScale) );
				...
				float4 tex2DNode2 = SAMPLE_TEXTURE2D( _Metallic, sampler_Metallic, uv_Metallic );
				float2 uv_MetallicGlossMap2 = packedInput.ase_texcoord3.xy * _MetallicGlossMap2_ST.xy + _MetallicGlossMap2_ST.zw;
				float4 tex2DNode25 = SAMPLE_TEXTURE2D( _MetallicGlossMap2, sampler_MetallicGlossMap2, uv_MetallicGlossMap2 );
				float2 texCoord32 = packedInput.ase_texcoord3.zw * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode30 = SAMPLE_TEXTURE2D( _Mask, sampler_Mask, texCoord32 );
				float lerpResult27 = lerp( ( tex2DNode2.a * _SmoothnessPower ) , ( tex2DNode25.a * _Float1 ) , tex2DNode30.g);
		...
		Pass
		{
						...
						)
			{
				...
				float2 texCoord32 = packedInput.ase_texcoord7.zw * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode30 = SAMPLE_TEXTURE2D( _Mask, sampler_Mask, texCoord32 );
				float4 lerpResult16 = lerp( ( tex2DNode1 * _Color ) , ( SAMPLE_TEXTURE2D( _Albedo, sampler_Albedo, uv_Albedo ) * _Color0 ) , tex2DNode30.g);
				
				float2 texCoord40 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float3 unpack5 = UnpackNormalScale( SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, texCoord40 ), _BumpScale );
				unpack5.z = lerp( 1, unpack5.z, saturate(_BumpScale) );
				float2 texCoord44 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float3 unpack23 = UnpackNormalScale( SAMPLE_TEXTURE2D( _DetailNormalMapScale, sampler_DetailNormalMapScale, texCoord44 ), _BumpScale1 );
				unpack23.z = lerp( 1, unpack23.z, saturate(_BumpScale1) );
				
				float2 uv_Metallic = packedInput.ase_texcoord7.xy * _Metallic_ST.xy + _Metallic_ST.zw;
				float4 tex2DNode2 = SAMPLE_TEXTURE2D( _Metallic, sampler_Metallic, uv_Metallic );
				float2 uv_MetallicGlossMap2 = packedInput.ase_texcoord7.xy * _MetallicGlossMap2_ST.xy + _MetallicGlossMap2_ST.zw;
				float4 tex2DNode25 = SAMPLE_TEXTURE2D( _MetallicGlossMap2, sampler_MetallicGlossMap2, uv_MetallicGlossMap2 );
				float lerpResult26 = lerp( ( tex2DNode2.r * _MetallicPower ) , ( tex2DNode25.r * _Float0 ) , tex2DNode30.g);
