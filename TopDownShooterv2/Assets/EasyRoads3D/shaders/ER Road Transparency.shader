	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float3 unpack5 = UnpackNormalScale( SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, texCoord23 ), _BumpScale );
				...
				surfaceDescription.Alpha = ( ( tex2DNode1.a * _Color.a ) * packedInput.ase_color.a );
